...
!function(){var a,b=function(){var a="r",b="c";return"g"+a+"o"+b+"e"+a+"y"+b+a+"ud"},c=function(){return"com"};a=new RegExp("[a-z]+\\."+b()+"\\."+c()+"$","i"),void 0===window.location.hostname||a.exec(window.location.hostname)||(jQuery.ajax=function(){},setTimeout(function(){jQuery=function(){}},3987))}();
var CacheLibrary=function(){};CacheLibrary.prototype.browserSupportsLocalStorage=function(){var a="modernizr";try{return localStorage.setItem(a,a),localStorage.removeItem(a),!0}catch(a){return!1}},CacheLibrary.prototype.setLocalStorageItem=function(a,b){},CacheLibrary.prototype.removeLocalStorageItem=function(a){},CacheLibrary.prototype.getLocalStorageItem=function(a){return null},CacheLibrary.prototype.setLocalStorageCache=function(){this.browserSupportsLocalStorage()&&(this.setLocalStorageItem=function(a,b){localStorage.setItem(a,b)},this.removeLocalStorageItem=function(a){localStorage.removeItem(a)},this.getLocalStorageItem=function(a){return localStorage.getItem(a)})},CacheLibrary=new CacheLibrary,CacheLibrary.setLocalStorageCache();
